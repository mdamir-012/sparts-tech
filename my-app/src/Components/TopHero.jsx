      ...
      <div className="w-full h-screen max-w-full rounded-lg overflow-hidden shadow-lg relative">
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex items-center text-left text-white bg-opacity-50 p-5 rounded-lg font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl ml-4 sm:ml-8 md:ml-12 lg:ml-16">
            <p className="animate__animated animate__fadeInLeft transition duration-500 ease-in-out text-white font-mono text-6xl">
          ...
          <div className="absolute bottom-6 w-full flex flex-col md:flex-row justify-center py-4">
            <button className="w-full lg:w-72 text-lg sm:text-xl md:text-2xl lg:text-3xl bg-gradient-to-r from-yellow-400 to-yellow-500 text-white p-3 rounded-full mb-2 md:mb-0 md:mr-2.5 mt-10 hover:from-yellow-500 hover:to-orange-600 shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out">
              For Academies
            </button>
            <button className="w-full lg:w-96 text-lg sm:text-xl md:text-2xl lg:text-3xl bg-gradient-to-r from-yellow-400 to-orange-600 text-white p-3 rounded-full mt-10 hover:from-yellow-500 hover:to-yellow-600 shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out">
              SpArts in your home
            </button>
          </div>
        </div>
